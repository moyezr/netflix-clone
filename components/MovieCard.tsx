...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <Image width={1000} height={1000} onClick={redirectToWatch} src={data.thumbnailUrl} alt="Movie" draggable={false} className="
        cursor-pointer
        object-cover
        transition
        duration
      ...
      ">
        <Image width={400}  height={1000}  onClick={redirectToWatch} src={data.thumbnailUrl} alt="Movie" draggable={false} className="
          cursor-pointer
          object-cover
          transition
          duration
        ...
        <div className="
          ...
          <p className="text-green-1000 font-semibold mt-4">
